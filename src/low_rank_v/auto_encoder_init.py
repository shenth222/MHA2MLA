...
def merge():
    ...
    low_rank_patch_hf()
    original_model = AutoModelForCausalLM.from_pretrained("../checkpoints/rope_v0_svd_v_method2_rank8_silu/0_hf")
    model = AttnForTraing.from_pretrained("../checkpoints/rope_v0_svd_v_method2_rank8_silu_auto_encoder_l1/checkpoint-2000")
    with torch.no_grad():
