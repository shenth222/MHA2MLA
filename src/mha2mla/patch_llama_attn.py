...
def patch_llama_attn():
    """
    Patch the LlamaAttention class to use the custom forward function.
    """
    LlamaAttention.forward = llama_attn_forward

def get_qk_states():
    """
    Get the q and k states from the LlamaAttention class.
    """
    return q, k

def get_qk_embed_states():
    """
