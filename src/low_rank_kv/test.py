...
if __name__ == "__main__":
    ...
    model = trainer.model
    model.eval()
    for layer_id in range(config["model"]["model_config"]["num_hidden_layers"]):
        print(model.model.decoder[layer_id].pp_block.attn.W_down_v.weight)
        print(model.model.decoder[layer_id].pp_block.attn.W_up_v.weight)