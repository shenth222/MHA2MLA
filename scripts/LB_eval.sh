...
BaseModel="../checkpoints/7B_1/12000_hf"
BSZ=16
OUTPUT_DIR="../images/new_longbench_7B_baseline"
...
python ../src/evaluation/lb_table.py \
    --path /cpfs01/shared/llm_ddd/doushihan/taoji/code/MLA-FT/images/new_longbench_7B_baseline