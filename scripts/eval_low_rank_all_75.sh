...
eval_one_ckpt() {
    ...
    accelerate launch --multi_gpu --num_processes=${NUM_GPUS} --main_process_port 25675 \
        -m src.low_rank_k_nope.eval --cfg_RoPE ${cfg_RoPE} \
        accelerate \
...
eval_all ../checkpoints/v2_start0_step8_svd_method2_W_k_nope_rank8 v2_start0_step8_svd_method2_W_k_nope_rank8 ../configs/low_rank/v2_start0_step8_svd_method2_W_k_nope_rank8.yaml