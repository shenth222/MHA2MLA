...
# eval_one_ckpt_hf /home/binguo/data/models/HuggingFaceTB/SmolLM-360M SmolLM-360M


# model_name_or_path="/home/binguo/data/models/HuggingFaceTB/SmolLM-135M"
# output_dir="SmolLM-135M_HQQ_bf16"
# accelerate launch --multi_gpu --num_processes=${NUM_GPUS} --main_process_port 25675 \
#     -m  lighteval accelerate \
#     "pretrained=${model_name_or_path},revision=main,dtype=bfloat16,max_length=2048" \
#     "../src/evaluation/smollm1_base_v2.txt" \
#     --override-batch-size 48 \
#     --custom-tasks "../src/evaluation/tasks.py" \
#     --output-dir "../eval_results/${output_dir}"

model_name_or_path="/home/binguo/data/models/HuggingFaceTB/SmolLM-135M"
output_dir="SmolLM-135M_HQQ_int2"
accelerate launch --multi_gpu --num_processes=${NUM_GPUS} --main_process_port 25675 \
    -m  lighteval accelerate \
    "pretrained=${model_name_or_path},revision=main,dtype=bfloat16,max_length=2048,generation_config=HQQ_int2" \
    "../src/evaluation/smollm1_base_v2.txt" \
    --override-batch-size 48 \
    --custom-tasks "../src/evaluation/tasks.py" \
    --output-dir "../eval_results/${output_dir}"
